...
pub fn parse_args() -> Args {
    ...
    Args {
        vcf_file: matches.get_one::<String>("vcf").expect("--vcf is required").to_string(),
        bam_file: matches.get_one::<String>("bam").cloned(),
        fasta_file: matches.get_one::<String>("fasta").expect("--fasta is required").to_string(),
        genes_file,
        ...
        min_quality: *matches.get_one::<u8>("quality").expect("--quality has default"),
        min_mapq: *matches.get_one::<u8>("mapq").expect("--mapq has default"),
        threads: matches.get_one::<usize>("threads").copied(),
        min_snp_reads: *matches.get_one::<usize>("min_snp_reads").expect("--snp has default"),
        min_mnv_reads: *matches.get_one::<usize>("min_mnv_reads").expect("--mnv has default"),
        min_snp_strand_reads: *matches.get_one::<usize>("min_snp_strand_reads").expect("--min-snp-strand has default"),
        min_mnv_strand_reads: *matches.get_one::<usize>("min_mnv_strand_reads").expect("--min-mnv-strand has default"),
        min_strand_bias_p: *matches.get_one::<f64>("min_strand_bias_p").expect("--min-strand-bias-p has default"),
